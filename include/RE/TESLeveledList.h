...
namespace RE
{
	...
	public:
		...
		bool			Calculate(UInt16 a_level, UInt16 a_count, BSScrapArray<CalculatedResult>& a_result, bool a_ignoreChanceValue = false, bool a_unk5 = true);
	...
	private:
		typedef bool _Calculate_Impl_t(TESLeveledList* a_this, UInt16 a_level, UInt16 a_count, BSScrapArray<CalculatedResult>& a_result, bool a_ignoreChanceValue, bool a_unk5);
		static RelocAddr<_Calculate_Impl_t*> _Calculate_Impl;
	};
