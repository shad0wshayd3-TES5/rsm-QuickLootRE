...
namespace CLIK
{
	...
	bool TextField::AddListener(Object& a_listener)
	{
		...
		RE::GFxValue boolean;
		[[maybe_unused]] auto success = Invoke("addListener", std::addressof(boolean), args, kNumArgs);
		assert(success);
	...
	{
		RE::GFxValue number;
		[[maybe_unused]] auto success = Invoke("getDepth", std::addressof(number));
		assert(success);
	...
	bool TextField::RemoveListener(Object& a_listener)
	{
		...
		RE::GFxValue boolean;
		[[maybe_unused]] auto success = Invoke("removeListener", std::addressof(boolean), args, kNumArgs);
		assert(success);
	...
	{
		[[maybe_unused]] auto success = Invoke("removeTextField");
		assert(success);
	}
	...
	void TextField::ReplaceSel(std::string_view a_newText)
	{
		...
		[[maybe_unused]] auto success = Invoke("replaceSel", nullptr, args, kNumArgs);
		assert(success);
	}
	...
	void TextField::ReplaceText(double a_beginIndex, double a_endIndex, std::string_view a_newText)
	{
		...
		[[maybe_unused]] auto success = Invoke("replaceText", nullptr, args, kNumArgs);
		assert(success);
	}
	...
	void TextField::AppendText(std::string_view a_newText)
	{
		...
		[[maybe_unused]] auto success = Invoke("appendText", nullptr, args, kNumArgs);
		assert(success);
	}
	...
	void TextField::AppendHtml(std::string_view a_newHtml)
	{
		...
		[[maybe_unused]] auto success = Invoke("appendHtml", nullptr, args, kNumArgs);
		assert(success);
	}
	...
	double TextField::GetCharIndexAtPoint(double a_x, double a_y)
	{
		...
		RE::GFxValue number;
		[[maybe_unused]] auto success = Invoke("getCharIndexAtPoint", std::addressof(number), args, kNumArgs);
		assert(success);
	...
	double TextField::GetFirstCharInParagraph(double a_charIndex)
	{
		...
		RE::GFxValue number;
		[[maybe_unused]] auto success = Invoke("getFirstCharInParagraph", std::addressof(number), args, kNumArgs);
		assert(success);
	...
	double TextField::GetLineIndexAtPoint(double a_x, double a_y)
	{
		...
		RE::GFxValue number;
		[[maybe_unused]] auto success = Invoke("getLineIndexAtPoint", std::addressof(number), args, kNumArgs);
		assert(success);
	...
	double TextField::GetLineLength(double a_lineIndex)
	{
		...
		RE::GFxValue number;
		[[maybe_unused]] auto success = Invoke("getLineLength", std::addressof(number), args, kNumArgs);
		assert(success);
	...
	Object TextField::GetLineMetrics(double a_lineIndex)
	{
		...
		RE::GFxValue object;
		[[maybe_unused]] auto success = Invoke("getLineMetrics", std::addressof(object), args, kNumArgs);
		assert(success);
	...
	double TextField::GetLineOffset(double a_lineIndex)
	{
		...
		RE::GFxValue number;
		[[maybe_unused]] auto success = Invoke("getLineOffset", std::addressof(number), args, kNumArgs);
		assert(success);
	...
	std::string_view TextField::GetLineText(double a_lineIndex)
	{
		...
		RE::GFxValue str;
		[[maybe_unused]] auto success = Invoke("getLineText", std::addressof(str), args, kNumArgs);
		assert(success);
	...
	void TextField::CopyToClipboard(bool a_richClipboard, double a_startIndex, double a_endIndex)
	{
		...
		[[maybe_unused]] auto success = Invoke("copyToClipboard", nullptr, args, kNumArgs);
		assert(success);
	}
	...
	void TextField::CutToClipboard(bool a_richClipboard, double a_startIndex, double a_endIndex)
	{
		...
		[[maybe_unused]] auto success = Invoke("cutToClipboard", nullptr, args, kNumArgs);
		assert(success);
	}
	...
	void TextField::PasteFromClipboard(bool a_richClipboard, double a_startIndex, double a_endIndex)
	{
		...
		[[maybe_unused]] auto success = Invoke("pasteFromClipboard", nullptr, args, kNumArgs);
		assert(success);
	}
}
